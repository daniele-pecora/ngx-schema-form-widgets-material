...
var simpleParser = new BBCode({
  ...
  '\\[h1a( class=.+?)?( role=.+?)?( tabindex=.+?)?( data-[\\S]+?=??.*?)*( aria-[\\S]+?=??.*?)*\\](.+?)\\[/h1a\\]': '<h11$1$2$3$4$5><a rel="noopener noreferrer" href="$5" name="$6">$6</a></h1>',
  '\\[h2a( class=.+?)?( role=.+?)?( tabindex=.+?)?( data-[\\S]+?=??.*?)*( aria-[\\S]+?=??.*?)*\\](.+?)\\[/h2a\\]': '<h21$1$2$3$4$5><a rel="noopener noreferrer" href="$5" name="$6">$6</a></h2>',
  '\\[h3a( class=.+?)?( role=.+?)?( tabindex=.+?)?( data-[\\S]+?=??.*?)*( aria-[\\S]+?=??.*?)*\\](.+?)\\[/h3a\\]': '<h31$1$2$3$4$5><a rel="noopener noreferrer" href="$5" name="$6">$6</a></h3>',
  '\\[h4a( class=.+?)?( role=.+?)?( tabindex=.+?)?( data-[\\S]+?=??.*?)*( aria-[\\S]+?=??.*?)*\\](.+?)\\[/h4a\\]': '<h41$1$2$3$4$5><a rel="noopener noreferrer" href="$5" name="$6">$6</a></h4>',
  '\\[h5a( class=.+?)?( role=.+?)?( tabindex=.+?)?( data-[\\S]+?=??.*?)*( aria-[\\S]+?=??.*?)*\\](.+?)\\[/h5a\\]': '<h51$1$2$3$4$5><a rel="noopener noreferrer" href="$5" name="$6">$6</a></h5>',
  '\\[h6a( class=.+?)?( role=.+?)?( tabindex=.+?)?( data-[\\S]+?=??.*?)*( aria-[\\S]+?=??.*?)*\\](.+?)\\[/h6a\\]': '<h61$1$2$3$4$5><a rel="noopener noreferrer" href="$5" name="$6">$6</a></h6>',
